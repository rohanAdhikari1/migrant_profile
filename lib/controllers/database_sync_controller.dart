...
import 'package:survey/repositories/api_repository.dart';
  ...
  void syncData() async{
   ...
   if(selectedItems.isNotEmpty){
     for (var itemId in selectedItems) {
       ...
       var houseRepresentative = await recordRepository.retrieveHouseRepresentative(record['house_representative_id']);
       var recordJson = {
         ...
         'family_memeber_count':houseRepresentative['family_members_male_count']??0+houseRepresentative['family_members_female_count']??0+houseRepresentative['family_members_other_count']??0,
         'family_members_male_count':houseRepresentative['family_members_male_count'],
         'family_members_female_count': houseRepresentative['family_members_female_count'],
         'family_members_other_count':houseRepresentative['family_members_other_count'],
         'family_migration_count':houseRepresentative['family_migration_count'],
         'family_members_migration_male_count':houseRepresentative['family_members_migration_male_count'],
         'family_members_migration_female_count':houseRepresentative['family_members_migration_female_count'],
         'family_members_migration_other_count':houseRepresentative['family_members_migration_other_count'],
